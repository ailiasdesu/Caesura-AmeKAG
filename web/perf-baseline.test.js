...
describe('web player performance baseline (round 109)', () => {
  ...
  it('story.ks main path: frame throughput + completes clean', async () => {
    ...
    expect(r.framesPerMs, 'story.ks frame throughput >= 1.3 frames/ms').toBeGreaterThan(1.3)
    expect(r.tokensPerMs, 'story.ks token throughput >= 0.15 tokens/ms').toBeGreaterThan(0.15)
