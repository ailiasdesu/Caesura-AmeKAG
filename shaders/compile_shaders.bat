...
for %%S in (fs_texture fs_blend fs_transition fs_vfx fs_postfx_vignette fs_postfx_lut fs_postfx_blur fs_postfx_bloom fs_postfx_lut3d stretch_blt_fs affine_blt_fs minigame_fs) do (
    set "SRC=%GLSL_DIR%\%%S.sc"
    set "OUT=%OUT_SUBDIR%\%%S!EXT!"
    if exist "!SRC!" (
        echo   [FS] %%S
