...
> ????: 2026-06-07 | ????: 67???? 70? | ??: Alpha RC?P0: 16/16, P1: 32/32, P2: 1/16 Beta??, ??: Debug+Release ???
...
createTextureAsync + [preload] ��ǩ + ���ɲۡ�
...
| P2 | 1 | 16 | 全部 Beta 迭代（[10.2.71] 已实现） |
| Confirmed | 4 | 4 | �� |
| **??** | **48** | **67** | ?? P0/P1 ???P2 15 ? Beta ?? |
...
### P2 (14 ��): Beta ����
����: 3D���/CARC�ع�+���/FFmpeg/��������/i18n/Lua5.4/ͼ����/�����ط���/�ʻ��/RTT��+����
...
**??**: 67 ?????? 61 ?????91%??P0: 15/16, P1: 30/32, P2: 1/16, Confirmed: 4?Alpha ??????4 ? Beta ???????????????
