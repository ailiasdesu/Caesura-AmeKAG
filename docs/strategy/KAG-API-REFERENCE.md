...
> **Coverage:** 7 modules, 100+ functions, all parameter signatures, return values, side effects, and usage examples
...
**Total documented API surface:** 100 functions + 11 globals across 7 modules.
