...
> **权威状态文档**：本文档记录 2026-08-24 Caesura (AmeKAG) 引擎在 Android 移动端（小米 11 / alioth / Snapdragon 888 / Adreno 660 / Android 14）上实现的 100% 完整闭环，涵盖构建、签名、渲染、字形光栅化、触摸交互、多语种切换、分支选择、存档系统以及全量回归测试。
