...
- 分布（178 条 finding，各桶之和一致）：R1 认知过载 58、R2 变更传播 83、R3 知识重复 33、R4 偶发复杂 4（R5/R6 无——无循环依赖/依赖方向正确）；201 文件
- 启发式 health_score 0/危险（92C+84W+2S=178）——**正则+花括号粗粒度统计，假阳性率高**，不作为绝对评分
