...
- [x] **Web (Tier 1)**: Vitest suite green (cd web && npm test; 369 tests (342 passed + 27 environment-skipped) / 27 files measured 2026-08-28), CDP real-browser unlock and reload save persistence verified.
