...
[fg path="test_chara.png"]
[wait time=300]
[ch name="旁白" text="前景立绘已设置。"]

[image layer="fg" path="test_chara.png"]
...
*test_audio
[playbgm path="bgm/test.ogg" volume=0.8]
...
[playse path="se/click.wav" volume=0.5]
[ch name="旁白" text="SE 已触发。"]

[stopse]
[ch name="旁白" text="SE 已停止。"]

[playvoice path="voice/line001.ogg"]
...
[preload type="texture" path="test_bg.png" wait="true"]
[preload type="texture" path="test_chara.png"]
